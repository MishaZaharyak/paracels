...
(function ($) {
    ...
    if (doctorsSlider.length) {
        ...
        $(doctorsSliderNav).slick({
            ...
            speed: 500,
            nextArrow: doctorsSliderNav
                .closest(".doctors-section-inner")
                .find(".slick_next"),
            prevArrow: doctorsSliderNav
                .closest(".doctors-section-inner")
                .find(".slick_prev")
        });
...
$("form").submit(function (e) {
    ...
    if (!phone.match(/^[\+]?([0-9]{12})$/)) {
        $(o)
            .find(".alert")
            .removeClass("alert-primary d-none")
            .addClass("alert-danger")
            .fadeIn()
            .html("Формат номеру повинен бути +380*********");
        return;
    }
    ...
    $.ajax({
        ...
        $(o)
            ...
            .fadeIn()
            .html("Ваше замовлення передане адміністратору");
        setTimeout(function () {
            $(o)
                .find(".alert")
                .addClass("d-none")
...
if (certificates.length) {
    ...
    $(certificates).find('.certificates-image').on('click', function (event) {
